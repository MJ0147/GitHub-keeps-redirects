...
echo -n "postgresql://<user>:<password>@<cockroach-host>:26257/ekioba_store?sslmode=require" | gcloud secrets create COCKROACHDB_STORE_URL --data-file=-
echo -n "postgresql://<user>:<password>@<cockroach-host>:26257/ekioba_hotels?sslmode=require" | gcloud secrets create COCKROACHDB_HOTELS_URL --data-file=-
```
